...
#
# This Julia code is optimized for 5th Gen AMD EPYC CPU (Zen 5 core)
#
# L1D cache: 48 KiB = 49152 bytes
# here: 360 * 16 * Float64 = 46080 bytes
const ROW_CACHE = 360
const K_CACHE   =  16
const COL_CACHE = 180
#
# SIMD vector registers: 32 ZMM0 - ZMM31, each 512-bit wide
# here (max): 5 * (4 + 1) + 4 = 29
const ROW_SIMD  =  40 # 5 * 8 Float64 (one 512-bit register)
const COL_SIMD  =   4
